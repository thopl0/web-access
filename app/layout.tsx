...
// Google Analytics 4 measurement ID. CookieConsent loads gtag.js (via @next/third-parties, which also
// reports App Router client-side navigations) ONLY after the visitor opts in, and remembers the
// choice. Gated to production below so local dev traffic never lands in the property.
...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      {process.env.NODE_ENV === 'production' ? <CookieConsent gaId={GA_ID} /> : null}
    </html>
  );
}
